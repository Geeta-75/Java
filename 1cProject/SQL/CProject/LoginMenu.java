        ...
        sc.nextLine();
    	  if(isValidRoll(stRoll)) {
    		break;
    		  ...
    		  System.out.println("Roll number can only contain 4 digits");
    	  }
        ...
        try {
        	if(dbManager.checkStudent(stRoll, stCon)) {
        		...
        		try {
        	         ...
        	         CProvider cpInfo = dbManager.getCProvider(student.getStudentID());
//        	         Course course = dbManager.getCourses(student.getStCourseID());
        	        userSt = new UserStudent(student,cpInfo,dbManager);
    ...
    public void signUpAsStudent() {
        ...
        System.out.println("Create your Roll Number : ");
        while(true) {
        stRoll = sc.nextInt();
        sc.nextLine();
    	  if(isValidRoll(stRoll)) {
        ...
        Student newStudent = new Student(stName,stRoll,stCon);
        try {
        dbManager.addStudent(newStudent, CPID);
        }catch(SQLException e) {
        	System.out.println("Course Provider with ID "+CPID+" doesn't exist\nPlease recheck Course Provider ID");
        	signUpAsStudent();
        }
